                                        ...
                                        <div class="tab-pane" id="settings">
                                            <form class="form-horizontal" method="POST" action="./salva_cad_produto.php">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="number" name="valor" class="form-control" id="inputEmail" placeholder="Valor">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="number" name="quantidade" class="form-control" id="inputName2" placeholder="Quantidade">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
